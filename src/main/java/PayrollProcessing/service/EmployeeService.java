...
public class EmployeeService {
	...
	private TreeMap<Integer, List<Events>> eventRecords = new TreeMap<Integer, List<Events>>();
	...
	public List<Employee> findAll() {
		...
		System.out.println("EmpId     Designation    firstname    lastname");
		for (int i = 0; i < listRecords.size(); i++) {
			System.out.println(listRecords.get(i).getEmployeeId()+ "   "+listRecords.get(i).getDesignation() + "    " + listRecords.get(i).getEmpFName()+"   "+listRecords.get(i).getEmpLName());
    ...
    public void bonusUpdateOfEmployee(String employeeId, Employee e) {
        hm.put(employeeId, e);
    }
	...
	public void salaryUpdateofEmployee(String employeeId, Employee e) {
        hm.put(employeeId, e);
    }

    public void monthlySalaryData() {
	...
	public void yearlyEventRecords() {
		System.out.println("---------Yearly EventWise  Report------------------");
	   ...
	   public void monthwiseBonusReimbursementReport() {
	        LocalDate currentDate = LocalDate.now();
	        System.out.println("------------------------------------------------------------------------------------");
	        System.out.println(" ---Each month (salary + bonus + Reimbursement) Data---");
